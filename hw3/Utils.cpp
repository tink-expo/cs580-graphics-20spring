...
void GPMatrix::local2WCxForm(const GPVector3& U,const GPVector3& V,const GPVector3& W)
{
	IdentityMatrix();
	_11=U.x;_12=U.y;_13=U.z;
	_21=V.x;_22=V.y;_23=V.z;
	_31=W.x;_32=W.y;_33=W.z;
}
// ----------------------------------------------------------------------------
//  Name:	RotateXMatrix
...
{
	return s << "GPVector {" << v.x << ", " << v.y << ", " << v.z << ", " << v.w << "}";
}

std::ostream& operator<<(std::ostream& s,const GPVector3& v)
{
	return s << "GPVector3 {" << v.x << ", " << v.y << ", " << v.z << "}";
}
